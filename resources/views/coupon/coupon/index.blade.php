...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    <h3 class="box-title pull-left">Coupons</h3>
                    @can('add-'.str_slug('Coupon'))
                        <a class="btn btn-success pull-right" href="{{ url('/coupon/create') }}"><i
                                    class="icon-plus"></i> Add Coupon</a>
                    @endcan
                    <div class="clearfix">
                    <button style="margin-bottom: 10px;margin-right:10px;" class="btn btn-primary pull-right delete_all"  id="delete_all" data-url="{{ url('deleteAllCoupon') }}">Delete All Selected</button>
                        ...
                        <table class="table table-borderless data-checkbox" id="myTable">
                            ...
                            @foreach($coupon as $item)
                                <tr class="optionOne">
                                    ...
                                    <td style="text-align:center;">{{ $item->coupon }}</td>
                                    <td style="text-align:center;">{{ $item->coupon_type }}</td>
                                    <td style="text-align:center;">{{ $item->coupon_amount }}</td>
