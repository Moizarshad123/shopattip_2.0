...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="white-box">
                    <h3 class="box-title pull-left">Banners</h3>
                    @can('add-'.str_slug('Banner'))
                    
                        <a class="btn btn-success pull-right" href="{{ url('/banner/create') }}"><i
                                    class="icon-plus"></i> Add Banner</a>
                    @endcan
                    
                    <div class="clearfix">
                    <button style="margin-bottom: 10px;margin-right:10px;" class="btn btn-primary pull-right delete_all"  id="delete_all" data-url="{{ url('deleteAllBranner') }}">Delete All Selected</button>
                            ...
                            @foreach($banner as $item)
                                <tr class="optionOne">
                                    ...
                                    <td>
                                        ...
                                        @can('edit-'.str_slug('Banner'))
                                            <a href="{{ url('/banner/' . $item->id . '/edit') }}"
                                               title="Edit Banner">
