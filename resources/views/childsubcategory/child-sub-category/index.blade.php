        ...
        <div class="row">
            ...
            ?>
                ...
                <div class="white-box">
                    ...
                    @endcan
                    <div class="clearfix">
                    <button style="margin-bottom: 10px;margin-right:10px;" class="btn btn-primary pull-right delete_all"  id="delete_all" data-url="{{ url('deleteAllChildCategory') }}">Delete All Selected</button>
                    ...
                    <div class="table-responsive">
                            ...
                            @foreach($childsubcategory as $item)
                                <tr class="optionOne">
                                    ...
                                    <td>
                                        ...
                                        @can('edit-'.str_slug('ChildSubCategory'))
                                            <a href="{{ url('/child-sub-category/' . $item->id . '/edit') }}"
                                        ...
                                        @can('delete-'.str_slug('ChildSubCategory'))
                                            <form method="POST"
                                                  action="{{ url('/child-sub-category' . '/' . $item->id) }}"
                        ...
                        {{-- <div class="pagination-wrapper"> {!! $childsubcategory->appends(['search' => Request::get('search')])->render() !!} </div> --}}
                    </div>
                </div>
            </div>
        </div>
